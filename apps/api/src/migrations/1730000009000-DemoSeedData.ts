...
export class DemoSeedData1730000009000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Envolve tudo em bloco anônimo para ser resiliente a dados já existentes
    await queryRunner.query(`
      ...
      BEGIN
        ...
        VALUES
          ('d0000001-0000-0000-0000-000000000001', 'cidadao@demo.local',
           '$2b$12$8VmeAeBOTzppiyDNJkE4FuDN3FeXyn0PoDwFQoKrvCPrGt30zfO8m',
           'Ana Oliveira', '(77) 99801-0001', 'citizen', true, true),
          ('d0000001-0000-0000-0000-000000000002', 'mei@demo.local',
           '$2b$12$8VmeAeBOTzppiyDNJkE4FuDN3FeXyn0PoDwFQoKrvCPrGt30zfO8m',
           'João da Silva Santos', '(77) 99802-0002', 'mei', true, true),
          ('d0000001-0000-0000-0000-000000000003', 'empresa@demo.local',
           '$2b$12$8VmeAeBOTzppiyDNJkE4FuDN3FeXyn0PoDwFQoKrvCPrGt30zfO8m',
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        FROM (VALUES
          ('d0000009-0000-aced-0000-000000000001',
          ...
          ('d0000009-0000-aced-0000-000000000002',
          ...
          ('d0000009-0000-aced-0000-000000000003',
          ...
          ('d0000009-0000-aced-0000-000000000004',
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        SELECT
          'd0000009-0000-e000-0000-000000000001'::UUID,
          t.id,
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        SELECT
          'd0000009-0000-e000-0000-000000000010'::UUID,
          t.id,
          'd0000009-0000-e000-0000-000000000001'::UUID,
          'Depósito Principal',
          true
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        SELECT
          ...
          true
        FROM (VALUES
          ('d0000009-0000-e000-0000-000000000020', 'PAO-001', 'Pão Francês (kg)',          'KG',  '8.00',  '12.50', '5.00'),
          ('d0000009-0000-e000-0000-000000000021', 'PAO-002', 'Pão de Forma 500g',         'UN',  '4.50',   '8.90', '10.00'),
          ('d0000009-0000-e000-0000-000000000022', 'BOL-001', 'Bolo de Chocolate (fatia)', 'UN',  '3.00',   '7.00',  '5.00'),
          ('d0000009-0000-e000-0000-000000000023', 'SAL-001', 'Coxinha de Frango (un)',    'UN',  '1.80',   '4.50', '20.00'),
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        SELECT
          ...
          v.qty::DECIMAL(18,4)
        FROM (VALUES
          ('d0000009-0000-e000-0000-000000000020', '18.00'),
          ('d0000009-0000-e000-0000-000000000021', '24.00'),
          ('d0000009-0000-e000-0000-000000000022', '12.00'),
          ('d0000009-0000-e000-0000-000000000023', '45.00'),
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        FROM (VALUES
          ('d0000009-0000-e000-0000-000000000030', 'customer', 'Prefeitura Municipal de LEM',
           '00000000000100', 'compras@lem.ba.gov.br', '(77) 3628-0000'),
          ('d0000009-0000-e000-0000-000000000031', 'customer', 'Escola Municipal Centro',
           null, null, null),
          ('d0000009-0000-e000-0000-000000000032', 'supplier', 'Distribuidora de Farináceos BA',
           '98765432000101', 'vendas@farinaceos.com', '(71) 3500-9900'),
          ('d0000009-0000-e000-0000-000000000033', 'both',     'Supermercado Bom Preço LEM',
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE business_id = 'd0000009-0000-e000-0000-000000000001';
    `);
    await queryRunner.query(`
      DELETE FROM erp_parties WHERE id IN (
        'd0000009-0000-e000-0000-000000000030',
        'd0000009-0000-e000-0000-000000000031',
        'd0000009-0000-e000-0000-000000000032',
        'd0000009-0000-e000-0000-000000000033'
      );
    `);
    await queryRunner.query(`
      DELETE FROM erp_products WHERE business_id = 'd0000009-0000-e000-0000-000000000001';
    `);
    await queryRunner.query(`
      DELETE FROM erp_stock_locations WHERE id = 'd0000009-0000-e000-0000-000000000010';
    `);
    await queryRunner.query(`
      DELETE FROM erp_business_users WHERE business_id = 'd0000009-0000-e000-0000-000000000001';
    `);
    await queryRunner.query(`
      DELETE FROM erp_businesses WHERE id = 'd0000009-0000-e000-0000-000000000001';
    `);
    await queryRunner.query(`
