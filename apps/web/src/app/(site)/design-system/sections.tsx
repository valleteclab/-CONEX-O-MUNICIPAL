...
export function DesignSystemSections() {
  return (
    <div className="space-y-14 pb-8">
      ...
      <section id="cores" className="scroll-mt-40">
      ...
      <section id="tipo" className="scroll-mt-40">
      ...
      <section id="botoes" className="scroll-mt-40">
      ...
      <section id="formularios" className="scroll-mt-40">
      ...
      <section id="cards" className="scroll-mt-40">
      ...
      <section id="extras" className="scroll-mt-40">
